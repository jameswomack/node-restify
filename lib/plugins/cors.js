...
// Normal
let AC_ALLOW_ORIGIN = 'Access-Control-Allow-Origin';
let AC_ALLOW_CREDS = 'Access-Control-Allow-Credentials';
let AC_EXPOSE_HEADERS = 'Access-Control-Expose-Headers';
...
function cors(opts) {
    ...
    let headers = (opts.headers || []).slice(0);
